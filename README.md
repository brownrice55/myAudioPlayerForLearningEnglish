...
<p>自分の目標がリマインドされる仕掛けがあると良いように思うので、後で機能追加する可能性があります。</p>
...
<p>挫けそうな時があるので、気分を上げてくれる、楽しく勉強できる、また、毎日使おうと思える何かがあると良いと思うので、検討します（例えば、色、デザインが数パターンあって、基本設定などで変更可能、キャラクターが応援してくれる、利用の記録を見ることができる、等）。</p>
